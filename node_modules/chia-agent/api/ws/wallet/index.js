...
exports.on_message_from_wallet = exports.on_coin_added_of_wallet = exports.coin_added_command_of_wallet = exports.on_state_changed_of_wallet = exports.state_changed_command_of_wallet = exports.on_sync_changed_of_wallet = exports.sync_changed_command_of_wallet = exports.on_get_connections = exports.get_connections_command = exports.chia_wallet_service = void 0;
...
function on_get_connections(daemon, callback) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const messageListener = (e) => {
            if (e.origin === exports.chia_wallet_service && e.command === exports.get_connections_command) {
                callback(e);
            }
        };
...
function on_coin_added_of_wallet(daemon, callback) {
    return __awaiter(this, void 0, void 0, function* () {
        yield daemon.subscribe(types_1.metrics_service);
        const messageListener = (e) => {
            if (e.origin === exports.chia_wallet_service && e.command === exports.coin_added_command_of_wallet) {
                callback(e);
            }
        };
        return daemon.addMessageListener(exports.chia_wallet_service, messageListener);
...
exports.on_coin_added_of_wallet = on_coin_added_of_wallet;
