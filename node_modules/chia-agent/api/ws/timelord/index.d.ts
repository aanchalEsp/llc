...
export declare function on_finished_pot(daemon: TDaemon, callback: (e: GetMessageType<chia_timelord_service, finished_pot_command, TFinishedPotBroadCast>) => unknown): Promise<() => void>;
...
export declare function on_new_compact_proof(daemon: TDaemon, callback: (e: GetMessageType<chia_timelord_service, new_compact_proof_command, TNewCompactProofBroadCast>) => unknown): Promise<() => void>;
...
export declare function on_skipping_peak(daemon: TDaemon, callback: (e: GetMessageType<chia_timelord_service, skipping_peak_command, TSkippingPeakBroadCast>) => unknown): Promise<() => void>;
...
export declare function on_new_peak(daemon: TDaemon, callback: (e: GetMessageType<chia_timelord_service, new_peak_command, TNewPeakBroadCast>) => unknown): Promise<() => void>;
